...
use image::{DynamicImage, GenericImage, RgbImage, RgbaImage};
...
impl ImageTexture {
    pub fn new(filename: &str) -> Self {
        ...
        let ima: DynamicImage = image::open(&Path::new(filename)).unwrap();
        let w = ima.dimensions().0 as i32;
        Self {
            width: ima.dimensions().0 as i32,
            height: ima.dimensions().1 as i32,
        ...
        //     width:w as i32,
        //     height:h as i32,
        //     bytes_per_scanline:BYTES_PER_PIXEL * w as i32,
        //     img:ima,
        // }
    }
}
